...
{
    /// <summary>
    /// Finisht Rental output.
    /// </summary>
    public class FinishRentalOutput : IUseCaseOutput
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FinishRentalOutput"/> class.
        /// </summary>
        ...
        public FinishRentalOutput(Guid id, string vehicleLicencePlate, string clientId, DateTime startTime, DateTime? endTime)
        {
            Id = id;
