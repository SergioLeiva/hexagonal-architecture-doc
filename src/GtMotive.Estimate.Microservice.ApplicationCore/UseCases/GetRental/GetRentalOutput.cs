...
namespace GtMotive.Estimate.Microservice.ApplicationCore.UseCases.GetRental
{
    ...
    /// Get rental output.
    /// </summary>
    public class GetRentalOutput : IUseCaseOutput
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetRentalOutput"/> class.
        /// </summary>
        ...
        public GetRentalOutput(Guid id, string vehicleLicencePlate, string clientId, DateTime startTime, DateTime? endTime)
        {
            Id = id;
