...
{
    public record class CreateVehicleRequest : IRequest<IWebApiPresenter>
    {
        /// <summary>
        ...
        public CreateVehicleRequest(string fleetName, string licencePlate, string brand, int manufacturingYear, bool isRented)
        {
            FleetName = fleetName;
