...
namespace GtMotive.Estimate.Microservice.Api.UseCases.FinishRental
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FinishRentalResponse"/> class.
        /// </summary>
        ...
        public FinishRentalResponse(Guid id, string vehicleLicencePlate, string clientId, DateTime startTime, DateTime? endTime)
        {
            Id = id;
